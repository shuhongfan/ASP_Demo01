<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sy7-1.aspx.cs" Inherits="sy7_1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="GridView1" PageSize="4" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Number" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
