...
<body>
    ...
    <div>
        ...
        <table style="width: 500px;">
            <tr>
                <td style="text-align: center">批量更新数据</td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>将职称为:<asp:DropDownList ID="DropDownList1" runat="server">
                    <asp:ListItem>教授</asp:ListItem>
                    <asp:ListItem>副教授</asp:ListItem>
                    <asp:ListItem>讲师</asp:ListItem>
                    <asp:ListItem>助教</asp:ListItem>
                    </asp:DropDownList>
                    的职工的工资增加<asp:TextBox ID="TextBox1" runat="server" Width="60px"></asp:TextBox>
&nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="确定更新" Width="76px" />
                </td>
            </tr>
        </table>
